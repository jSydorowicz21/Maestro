 ...
 *
 * The AgentCapabilities type and DEFAULT_CAPABILITIES are the single source
 * of truth, imported from shared/agent-capabilities-types.ts. This module
 * re-exports them and adds the per-agent capability map.
 */

// Re-export the shared type and defaults — do NOT redefine locally
export type { AgentCapabilities } from '../../shared/agent-capabilities-types';
export { DEFAULT_CAPABILITIES } from '../../shared/agent-capabilities-types';
...
export const AGENT_CAPABILITIES: Record<string, AgentCapabilities> = {
	...
	'claude-code': {
		...
		supportsHarnessExecution: true, // Claude Agent SDK harness
	},
	...
	terminal: {
		...
		supportsHarnessExecution: false, // Terminal is not an AI agent
	},
	...
	'gemini-cli': {
		...
		supportsHarnessExecution: false, // PLACEHOLDER
	},
	...
	opencode: {
		...
		supportsHarnessExecution: false, // Future: OpenCodeHarness
	},
	...
	'factory-droid': {
		...
		usesJsonLineOutput: true, // Uses JSONL output format
		usesCombinedContextWindow: false, // Depends on model provider
		supportsHarnessExecution: false, // Future: FallbackCliHarness
	},
