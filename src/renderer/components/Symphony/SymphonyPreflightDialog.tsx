/**
 * Symphony Modal - Pre-flight Check Dialog
 *
 * Verifies gh CLI installation and authentication before starting
 * a contribution, then warns about build tool requirements.
 */
...
export function SymphonyPreflightDialog({
	theme,
	isCheckingGh,
	ghCliStatus,
	onClose,
	...
	ghCliStatus: { installed: boolean; authenticated: boolean } | null;
	onClose: () => void;
	onConfirm: () => void;
}) {
	return createPortal(
