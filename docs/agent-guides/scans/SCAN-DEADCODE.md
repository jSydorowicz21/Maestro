...
**Refreshed 2026-04-10 against origin/rc (06e5a2eb3)**: Spot-checked the 7 dead component files; all 7 still exist in rc with zero non-test imports (only test files reference them). Summary counts and store/shared/main findings not re-verified in this pass, but dead component list is confirmed current.
