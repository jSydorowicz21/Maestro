...
**Refreshed 2026-04-10 against origin/rc (06e5a2eb3)**: `src/shared/formatters.ts` still exposes the canonical `formatSize` (line 27), `formatNumber` (line 41), `formatElapsedTime` (line 144), `estimateTokenCount` (line 176), `formatElapsedTimeColon` (line 188). All listed duplicate definitions still exist in rc. New duplicates found in rc not in the original scan: `src/web/mobile/CuePanel.tsx:56 formatDuration`, `src/renderer/components/CueModal/cueModalUtils.ts:33 formatElapsed`. AIOverviewTab line shifted 62->78. No duplicates have been eliminated.
